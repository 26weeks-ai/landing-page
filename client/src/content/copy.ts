...
export const guarantee = {
  ...
  description: "If you're not satisfied with your progress within the first 30 days, we'll refund every penny. No questions asked."
};
...
export const pricing = {
  ...
  subtitle: "Start with a 2-week free trial. No credit card required.",
  plans: [
    {
      name: "Monthly",
      price: "20",
